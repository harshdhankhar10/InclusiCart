...
const menuItems  = [
  {
    ...
    submenu: ["Overview", "Statistics", "Activity Logs"],
  },
  {
    title: "Products",
    icon: Briefcase,
    path: "/admin/products",
    submenu: ["All Products", "Add Product", "Categories", "Inventory"],
  },
  {
    title: "Orders",
    icon: CheckSquare,
    path: "/admin/orders",
    submenu: ["All Orders", "Pending Orders", "Returns", "Refunds"],
  },
  {
    title: "Users",
    icon: Users,
    path: "/admin/users",
    submenu: ["Customer List", "Admins & Staff", "User Roles"],
  },
  {
    title: "Analytics",
    icon: BarChart,
    path: "/admin/analytics",
    submenu: ["Sales Reports", "Customer Insights", "Product Performance"],
  },
  {
    title: "Notifications",
    icon: Calendar,
    path: "/admin/notifications",
    submenu: ["All Notifications", "System Alerts", "Promotions"],
  },
  {
    title: "Support",
    icon: FolderOpen,
    path: "/admin/support",
    submenu: ["Support Tickets", "FAQs", "Contact Logs"],
  },
  {
    title: "Settings",
    icon: Settings,
    path: "/admin/settings",
    submenu: ["General Settings", "Store Policies", "Security Settings"],
  },
];
